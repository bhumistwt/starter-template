...
const Hero: FC = () => {
  ...
  return (
    <section>
      <div className="grid md:grid-col-12 md:h-screen items-strecth sticky top-0">
        ...
        <div className="md:col-span-5 relative">
          <motion.div className="mt-20 md:mt-0 md:size-full md:absoluten md:right-0 max-md:!w-full"
          style={{
            width: portraitWidth,
          }}
          >
